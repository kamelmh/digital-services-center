...
SERVICES = {
    ...
    "g13_declaration": {"name_fr": "G13 Déclaration BNC (professions libérales)", "name_ar": "تصريح G13 المهنة (المهن الحرة)", "price_min": 5_000, "price_max": 10_000, "delivery_days": 2, "category": "admin", "includes": ["Formulaire G13 rempli", "Calcul IRG 6 tranches", "Charges déductibles", "PDF"]},
    "g12_bis_declaration": {"name_fr": "G12 bis Déclaration IFU définitive", "name_ar": "تصريح G12 bis IFU النهائي", "price_min": 3_000, "price_max": 5_000, "delivery_days": 1, "category": "admin", "includes": ["Formulaire G12 bis rempli", "CA réel vs prévisionnel", "Ajustement IFU"]},
    "g51_declaration": {"name_fr": "G51 Attestation fiscale", "name_ar": "شهادة ضريبية G51", "price_min": 3_000, "price_max": 5_000, "delivery_days": 1, "category": "admin", "includes": ["Attestation fiscale", "Vérification obligations", "PDF"]},
    "g15_declaration": {"name_fr": "G15 Déclaration cessation d'activité", "name_ar": "تصريح G15 توقف النشاط", "price_min": 2_000, "price_max": 4_000, "delivery_days": 1, "category": "admin", "includes": ["Formulaire G15 rempli", "Durée d'exercice", "Obligations finales"]},
    "cnrc_f1_declaration": {"name_fr": "CNRC F1 Immatriculation (société)", "name_ar": "استمارة CNRC F1 التسجيل (شركة)", "price_min": 10_000, "price_max": 20_000, "delivery_days": 5, "category": "admin", "includes": ["Formulaire CNRC F1", "Tableau associés", "Timbre 4000 DA", "Checklist pièces"]},
    "cnrc_f2_declaration": {"name_fr": "CNRC F2 Immatriculation (commerçant)", "name_ar": "استمارة CNRC F2 التسجيل (تاجر)", "price_min": 5_000, "price_max": 10_000, "delivery_days": 3, "category": "admin", "includes": ["Formulaire CNRC F2", "Statut marital", "Checklist pièces"]},
    "das_declaration": {"name_fr": "DAS Déclaration annuelle CNAS", "name_ar": "DAS الإقرار السنوي CNAS", "price_min": 5_000, "price_max": 10_000, "delivery_days": 2, "category": "admin", "includes": ["DAS par salarié", "Cotisations 25.5%/9%", "Masse salariale"]},
    "secu01_declaration": {"name_fr": "SECU 01 Affiliation CNAS", "name_ar": "SECU 01 طلب الالتحاق CNAS", "price_min": 3_000, "price_max": 5_000, "delivery_days": 1, "category": "admin", "includes": ["Formulaire SECU 01", "Estimation cotisations", "Checklist"]},
    "nis_declaration": {"name_fr": "NIS Demande numéro identification stats", "name_ar": "NIS طلب رقم التعريف الإحصائي", "price_min": 2_000, "price_max": 4_000, "delivery_days": 1, "category": "admin", "includes": ["Formulaire NIS", "Classification ONS", "Effectif"]},
    "anae_declaration": {"name_fr": "ANAE Déclaration auto-entrepreneur", "name_ar": "ANAE تصريح النشاط", "price_min": 3_000, "price_max": 5_000, "delivery_days": 1, "category": "admin", "includes": ["Formulaire ANAE", "IFU 5%/12%", "Plafond checks"]},
    "casnos_declaration": {"name_fr": "CASNOS Affiliation + déclaration CA", "name_ar": "CASNOS الالتحاق + إقرار الفاتورة", "price_min": 3_000, "price_max": 5_000, "delivery_days": 1, "category": "admin", "includes": ["Affiliation CASNOS", "Déclaration CA annuelle", "15% cotisation"]},
    ...
    "creation_complete": {"name_fr": "Pack création complète (G8+CNRC+NIS+CASNOS)", "name_ar": "باقة الإنشاء الكاملة (G8+CNRC+NIS+CASNOS)", "price_min": 18_000, "price_max": 35_000, "delivery_days": 14, "category": "admin", "includes": ["G8 déclaration existence", "CNRC F1/F2 immatriculation", "NIS identification stats", "CASNOS affiliation", "Guide étapes"]},
    "ca_declaration_pack": {"name_fr": "Pack déclarations annuelles (G13+G12bis+G4+DAS)", "name_ar": "باقة التصريحات السنوية (G13+G12bis+G4+DAS)", "price_min": 15_000, "price_max": 25_000, "delivery_days": 7, "category": "admin", "includes": ["G13 BNC", "G12 bis IFU définitif", "G4 IBS annuel", "DAS CNAS"]},
